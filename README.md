...
> **Note on Project Evolution**: This repository documents my learning journey in computational linguistics. The `z_archive/` folder contains my initial exploratory work (Phase 1: Exploratory work). Based on that learning, I refocused the project on a more specific research question about contested political terms.
...
**Learned**: 
- Data collection (PDF extraction, OCR)
